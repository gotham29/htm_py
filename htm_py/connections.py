...
# class SegmentUpdate:
#     cell: int
#     segment: Optional[int]  # None if a new segment should be created
#     presynapticCells: Set[int]
#     sequenceSegment: bool = True
#     newSynapses: bool = True  # Should new synapses be grown?

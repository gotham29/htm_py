...
class TestConnections(unittest.TestCase):
    ...
    def test_create_segment_basic(self):
        # Create one segment on each cell
        segment_ids = []
    ...
    def test_multiple_segments_same_cell(self):
        # Create multiple segments for the same cell
        cell = 2
        ...
        self.assertEqual(set(segments), set([seg1, seg2, seg3]))
    ...
    def test_segment_and_synapse_id_monotonicity(self):
        # Create segments and synapses, assert monotonic ID assignment
    ...
    def test_create_synapse_on_multiple_segments(self):
        # Create synapses on different segments
    ...
    def test_create_segment_invalid_cell(self):
        ...
        with self.assertRaises(IndexError):
            self.conn.createSegment(self.num_cells)  # out of range
    ...
    def test_create_synapse_negative_permanence(self):
        ...
        data = self.conn._synapse_data[syn]
        self.assertLess(data.permanence, 0.0)  # Maybe warn? Or assert >= 0.0?
    ...
    def test_destroy_synapse_removes_everywhere(self):
        ...
        # Confirm removal from all places
    ...
    def test_update_synapse_permanence_successful(self):
        ...
        self.conn.updateSynapsePermanence(syn, 0.75)
        data = self.conn._synapse_data[syn]
    ...
    def test_update_synapse_permanence_nan(self):
        ...
        import math
        with self.assertRaises(ValueError):
            self.conn.updateSynapsePermanence(syn, math.nan)
    ...
    def test_no_orphan_synapses_after_destroy(self):
        ...
        # Ensure it's gone from all segments
    ...
    def test_segments_for_cell_valid_and_copy(self):
        ...
        # Mutate returned list, internal state must remain unchanged
        segs.clear()
    ...
    def test_num_cells_and_segmentFlatListLength(self):
        ...
        self.assertEqual(initial_cells, 10)  # From setup
